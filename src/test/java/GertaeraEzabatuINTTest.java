...
public class GertaeraEzabatuINTTest {
	...
	static BLFacadeImplementation sut = new BLFacadeImplementation();
	...
	@Test
	//pasatako gertaera ez dago datubasean, exception bat altsatu
	public void test2() {
		try {
			Event e = new Event(100, "probaEventua", new Date());
	...
	@Test
	//gertaera db-an dago, baina bere galdera bectorea hutsik
	public void test3() {
		try {
			//Egoera prestatu
			Date d = new Date();
	...
	@Test
	//gertaera db-an dago, baina bere galderak ez dituzte kuotarik
	public void test4() {
		try {
			//Egoera prestatu
			Date d = new Date();
	...
	@Test
	//gertaera db-an dago, galderak eta kuotak ditu baina azkeneko hauek ez dituzte apusturik
	public void test5() {
		try {
			//Egoera prestatu
			Date d = new Date();
	...
	@Test
	//gertaera db-an dago eta galderak, kuotak eta apustuak ditu
	public void test6() {
		try {
			//Egoera prestatu
			Date d = new Date();
