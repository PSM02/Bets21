...
//		});
		...
		btnNewButton = new JButton(ResourceBundle.getBundle("Etiquetas").getString("SelecionarEvento"));
		btnNewButton.setBounds(145, 274, 386, 61);
		getContentPane().add(btnNewButton);
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int i=tableEvents.getSelectedRow();
				domain.Event ev=(domain.Event)tableModelEvents.getValueAt(i,2);	
				JFrame a = new GertaeraBikoiztuGUI(ev);
