...
public class EmaitzakIpiniGUI extends JFrame {
	...
	private JComboBox komboKuotaList;
	private JButton AitortoButton;
...
//					jCalendar1.setCalendar(calendarAct);
		...
		scrollPaneQueries.setBounds(new Rectangle(40, 273, 378, 116));
		...
		tableQueries.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				komboKuotaList.setModel(Kuotak);
			}
		});
		...
		komboKuotaList = new JComboBox();
		komboKuotaList.setBounds(457, 276, 181, 21);
		getContentPane().add(komboKuotaList);
		
		AitortoButton = new JButton(ResourceBundle.getBundle("Etiquetas").getString("PutResults"));
		AitortoButton.setBounds(486, 350, 140, 34);
		getContentPane().add(AitortoButton);
		AitortoButton.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				BLFacade facade = MainGUI.getBusinessLogic();
				String k= (String)komboKuotaList.getSelectedItem();
				facade.emaitzakIpini(k);
			}
		});
